...
function ImageComparisonSlider() {
  ...
  return (
    <motion.div style={{ rotateX, rotateY, perspective: 1200 }} className="w-full max-w-6xl mx-auto aspect-video rounded-xl shadow-[0_0_80px_rgba(139,92,246,0.12)]">
      <div ref={containerRef} className="relative w-full h-full rounded-xl overflow-hidden cursor-crosshair select-none" onPointerMove={handlePointerMove} onPointerLeave={handlePointerLeave} style={{ transformStyle: "preserve-3d", border: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        <div className="absolute bottom-5 right-5 bg-[#1a1a1a99] backdrop-blur-xl px-4 py-2 rounded-lg pointer-events-none z-30" style={{ transform: "translateZ(30px)", border: "1px solid rgba(255,255,255,0.08)" }}>
          <span className="text-[11px] font-mono font-medium tracking-wider text-[#8B5CF6] uppercase">4x Upscaled</span>
        </div>
      </div>
    </motion.div>
  );
...
export default function LandingPage() {
  return (
    <div className="min-h-screen text-[#e5e2e1] font-sans selection:bg-[#8B5CF6]/30 overflow-x-hidden relative" style={{ background: "#050505" }}>
      {/* Ambient Mesh Glows */}
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute top-[40%] left-[50%] -translate-x-1/2 w-[30vw] h-[30vw] rounded-full bg-[#8B5CF6]/5 blur-[200px]" />
      </div>
      ...
      <nav className="fixed top-0 w-full z-50" style={{ background: "rgba(5,5,5,0.8)", backdropFilter: "blur(20px)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
        <div className="max-w-[1440px] mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <img src="/logo1.png" alt="Tensric Logo" className="w-8 h-8 object-contain" />
          ...
          <div className="flex items-center gap-5">
            <Link href="/login" className="text-sm font-medium text-[#958ea0] hover:text-[#8B5CF6] transition-colors">Sign In</Link>
            <Link href="/editor" className="text-sm font-bold bg-[#8B5CF6] text-[#050505] px-5 py-2.5 rounded-lg hover:shadow-[0_0_20px_rgba(139,92,246,0.5)] transition-all hover:brightness-110" style={{ borderTop: "0.5px solid rgba(255,255,255,0.3)" }}>Get Started</Link>
          </div>
        </div>
      </nav>
      ...
      <main className="relative z-10 pt-32">
        ...
        <section className="px-6 pb-20 pt-12 flex flex-col items-center text-center" style={{ paddingBottom: "80px" }}>
          <motion.div variants={stagger} initial="hidden" animate="show" className="flex flex-col items-center max-w-5xl mx-auto mb-16">
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-md mb-10 text-[#22D3EE] font-mono text-[12px] font-medium tracking-[0.1em] uppercase" style={{ background: "rgba(34,211,238,0.08)", border: "1px solid rgba(34,211,238,0.15)" }}>
            ...
            <motion.h1 variants={fadeUp} className="font-display text-[clamp(40px,7vw,80px)] font-extrabold tracking-[-0.04em] leading-[1.1] mb-6 text-white">
              Transform Pixels<br />Into <span className="bg-gradient-to-r from-[#8B5CF6] via-[#6D28D9] to-[#22D3EE] bg-clip-text text-transparent">Perfection.</span>
            </motion.h1>
            ...
            <motion.div variants={fadeUp} className="flex gap-4">
              <Link href="/editor" className="group flex items-center gap-3 bg-[#8B5CF6] text-[#050505] px-8 py-4 rounded-lg font-bold text-base transition-all hover:shadow-[0_0_30px_rgba(139,92,246,0.5)] hover:brightness-110" style={{ borderTop: "0.5px solid rgba(255,255,255,0.3)" }}>
        ...
        <section id="features" className="py-20 px-6" style={{ paddingTop: "80px", paddingBottom: "80px" }}>
          <div className="max-w-[1440px] mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16">
              <span className="font-mono text-[12px] font-medium tracking-[0.1em] uppercase text-[#22D3EE] mb-3 block">Features</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="md:col-span-2 rounded-xl p-10 relative overflow-hidden group transition-all duration-300 hover:shadow-[0_0_40px_rgba(139,92,246,0.08)]" style={{ background: "rgba(26,26,26,0.6)", backdropFilter: "blur(20px)", border: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <div className="relative z-10">
                  <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-6" style={{ background: "#1A1A1A", border: "1px solid rgba(255,255,255,0.06)" }}><Cpu className="w-7 h-7 text-[#8B5CF6]" /></div>
              ...
              {[
                ...
                <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} className="rounded-xl p-8 transition-all duration-300 hover:shadow-[0_0_30px_rgba(139,92,246,0.06)]" style={{ background: "rgba(26,26,26,0.6)", backdropFilter: "blur(20px)", border: "1px solid rgba(255,255,255,0.06)" }}>
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6" style={{ background: "#1A1A1A", border: "1px solid rgba(255,255,255,0.06)" }}><f.icon className="w-6 h-6 text-[#8B5CF6]" /></div>
        ...
        <section className="py-20 px-6" style={{ paddingTop: "80px", paddingBottom: "80px", borderTop: "1px solid rgba(255,255,255,0.04)", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
          <div className="max-w-[1440px] mx-auto text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16">
              <h2 className="font-display text-[clamp(32px,4vw,48px)] font-bold tracking-[-0.02em] text-white mb-4">Professional Control. <span className="bg-gradient-to-r from-[#8B5CF6] to-[#22D3EE] bg-clip-text text-transparent">Redefined.</span></h2>
              <p className="text-[#958ea0] max-w-xl mx-auto">Fine-tune every parameter with studio-grade precision tools.</p>
            </motion.div>
            <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="rounded-xl overflow-hidden max-w-5xl mx-auto shadow-[0_0_60px_rgba(139,92,246,0.08)]" style={{ border: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        <section id="stack" className="py-20 px-6" style={{ paddingTop: "80px", paddingBottom: "80px" }}>
          <div className="max-w-[1440px] mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
              <span className="font-mono text-[12px] font-medium tracking-[0.1em] uppercase text-[#22D3EE] mb-3 block">The Neural Stack</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="rounded-xl overflow-hidden group transition-all duration-300 hover:shadow-[0_0_40px_rgba(139,92,246,0.08)]" style={{ background: "rgba(26,26,26,0.6)", border: "1px solid rgba(255,255,255,0.06)" }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center max-w-5xl mx-auto">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="p-8 rounded-xl flex flex-col" style={{ background: "rgba(26,26,26,0.6)", border: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <ul className="space-y-4 mb-10 flex-1">
                  {["10 upscales/month", "Standard speed", "Up to 2x magnification"].map((item, i) => (<li key={i} className="flex items-center gap-3 text-[#cbc3d7] text-sm"><CheckCircle className="w-5 h-5 text-[#8B5CF6] flex-shrink-0" /><span>{item}</span></li>))}
                </ul>
              ...
              {/* Pro */}
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="p-10 rounded-xl flex flex-col relative md:-translate-y-4 shadow-[0_0_64px_rgba(139,92,246,0.15)]" style={{ background: "rgba(26,26,26,0.6)", border: "2px solid #8B5CF6" }}>
                <div className="absolute top-0 right-0 w-32 h-32 bg-[#8B5CF6]/20 rounded-full blur-[64px] translate-x-1/2 -translate-y-1/2" />
                <div className="relative z-10">
                  <div className="inline-block px-3 py-1 rounded-md mb-4 font-mono text-[11px] font-medium tracking-[0.1em] uppercase text-[#8B5CF6]" style={{ background: "rgba(139,92,246,0.15)", border: "1px solid rgba(139,92,246,0.25)" }}>Most Popular</div>
                  ...
                  <ul className="space-y-4 mb-10 flex-1">
                    {["Unlimited upscales", "Priority processing", "Up to 8x magnification", "API Access"].map((item, i) => (<li key={i} className="flex items-center gap-3 text-[#e5e2e1] text-sm"><CheckCircle className="w-5 h-5 text-[#8B5CF6] flex-shrink-0" /><span>{item}</span></li>))}
                  </ul>
                  <Link href="/login" className="block w-full py-3 px-6 rounded-lg font-bold bg-[#8B5CF6] text-[#050505] text-center hover:shadow-[0_0_20px_rgba(139,92,246,0.5)] transition-all" style={{ borderTop: "0.5px solid rgba(255,255,255,0.3)" }}>Upgrade to Pro</Link>
                </div>
              </motion.div>
              {/* Premium */}
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="p-8 rounded-xl flex flex-col" style={{ background: "rgba(26,26,26,0.6)", border: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <ul className="space-y-4 mb-10 flex-1">
                  {["Unlimited everything", "Dedicated GPU cluster", "Custom integrations", "24/7 Phone support"].map((item, i) => (<li key={i} className="flex items-center gap-3 text-[#cbc3d7] text-sm"><CheckCircle className="w-5 h-5 text-[#8B5CF6] flex-shrink-0" /><span>{item}</span></li>))}
                </ul>
        ...
        <section className="px-6 text-center relative" style={{ paddingTop: "80px", paddingBottom: "80px" }}>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative z-10 max-w-4xl mx-auto">
            <h2 className="font-display text-[clamp(40px,6vw,72px)] font-extrabold tracking-[-0.04em] leading-[1.1] mb-8 text-white">Bring Every Pixel<br />Back To <span className="bg-gradient-to-r from-[#8B5CF6] to-[#22D3EE] bg-clip-text text-transparent">Life.</span></h2>
            <Link href="/editor" className="inline-flex items-center gap-3 bg-[#8B5CF6] text-[#050505] px-10 py-5 rounded-lg font-bold text-lg hover:shadow-[0_0_40px_rgba(139,92,246,0.5)] hover:brightness-110 transition-all" style={{ borderTop: "0.5px solid rgba(255,255,255,0.3)" }}>
