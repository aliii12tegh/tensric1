...
export function AnimatedBackground() {
  return (
    <div className="fixed inset-0 w-full h-full pointer-events-none z-[-1] overflow-hidden bg-slate-950">
      ...
      {/* 3. ORB 1 (ELECTRIC VIOLET) */}
      <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-[#8B5CF6]/25 blur-[120px] animate-orb-1"></div>

      {/* 4. ORB 2 (DEEP INDIGO) */}
      <div className="absolute bottom-[-10%] right-[-10%] w-[45vw] h-[45vw] rounded-full bg-[#4C1D95]/25 blur-[120px] animate-orb-2"></div>
